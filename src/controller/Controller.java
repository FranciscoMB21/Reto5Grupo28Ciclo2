...
public class Controller {
    ...
    public void req15() {
        ...
        try {
            while (rs.next()) {
                Req1 req1 = new Req1(rs.getInt("total"), rs.getInt("id_proyecto"), rs.getString("pagado"),
    ...
    public void req25() {
        ...
        try {
            while (rs.next()) {
                Req2 req2 = new Req2(rs.getString("Inicio"), rs.getInt("financiable"), rs.getInt("estrato"),
